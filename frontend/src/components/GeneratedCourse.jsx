...
export function GeneratedCourse({ formData, onReset, onOpenQuiz, onOpenAssignments }) {
  ...
  const modules = generateModules(formData.courseName, levelDifference);
...
function generateModules(courseName, levelDifference) {
  const baseModules = [
    {
      id: 1,
      ...
      duration: "2-3 hours",
      lessons: [
        { title: "Course Overview and Expectations", type: "video", duration: "15 min" },
        { title: "Setting Up Your Environment", type: "reading", duration: "30 min" },
        { title: "First Steps and Basic Concepts", type: "video", duration: "45 min" },
        { title: "Practice Exercise: Getting Started", type: "exercise", duration: "1 hour" },
      ],
    },
    {
      id: 2,
      ...
      duration: "8-10 hours",
      lessons: [
        { title: "Core Principles and Theory", type: "video", duration: "1 hour" },
        { title: "Essential Terminology", type: "reading", duration: "45 min" },
        { title: "Hands-on Practice Session", type: "exercise", duration: "2 hours" },
        { title: "Building Your First Project", type: "project", duration: "4 hours" },
        { title: "Review and Assessment", type: "exercise", duration: "1.5 hours" },
      ],
    },
    {
      id: 3,
      ...
      lessons: [
        { title: "Advanced Concepts Introduction", type: "video", duration: "1.5 hours" },
        { title: "Best Practices and Patterns", type: "reading", duration: "1 hour" },
        { title: "Practical Applications", type: "video", duration: "2 hours" },
        { title: "Complex Exercise Set", type: "exercise", duration: "3 hours" },
        { title: "Mid-Level Project", type: "project", duration: "6 hours" },
      ],
    },
    {
      id: 4,
      ...
      lessons: [
        { title: "Professional Techniques", type: "video", duration: "2 hours" },
        { title: "Industry Standards and Tools", type: "reading", duration: "1.5 hours" },
        { title: "Advanced Problem Solving", type: "exercise", duration: "4 hours" },
        { title: "Comprehensive Project", type: "project", duration: "8 hours" },
        { title: "Code Review and Optimization", type: "video", duration: "2 hours" },
      ],
    },
    {
      id: 5,
      ...
      duration: "20+ hours",
      lessons: [
        { title: "Expert-Level Concepts", type: "video", duration: "2.5 hours" },
        { title: "Cutting-Edge Techniques", type: "reading", duration: "2 hours" },
        { title: "Real-World Case Studies", type: "video", duration: "3 hours" },
        { title: "Capstone Project", type: "project", duration: "12 hours" },
        { title: "Final Assessment and Certification", type: "exercise", duration: "2 hours" },
      ],
    },
  ];
