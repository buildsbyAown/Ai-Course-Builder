...
interface CourseBuilderFormProps {
  onGenerate: (data: CourseFormData) => void;
...
export function CourseBuilderForm({ onGenerate, isGenerating = false }: CourseBuilderFormProps) {
  ...
  const getTimeRecommendation = (hours: number) => {
