...
import { GeneratedCourse } from "./GeneratedCourse.jsx";
...
export function CourseBuilderPage({ onLogout, onProfile, onMyCourses, onProgress, onOpenQuiz, onOpenAssignments }) {
  const [generatedCourse, setGeneratedCourse] = useState(null);
  const [isGenerating, setIsGenerating] = useState(false);

  const handleGenerateCourse = (data) => {
